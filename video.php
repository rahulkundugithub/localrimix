					...
					<div class="col-lg-8">
						<div class="pittube-video">
							<div class="video-frame">
								<video id="my_video_1" class="video-js vjs-default-skin" controls preload="none" height="370" data-setup="{}"
poster="http://video-js.zencoder.com/oceans-clip.jpg">
								...
								<ul class="pit-opt">
									<li>
										<div title="Like/Dislike" class="likes heart">❤ <span>1.6k</span></div>
									</li>
									<li title="Comments" class="comentz"><i class="fa fa-comment"></i><em>2.2k</em></li>
									<li title="Save Post" class="save-post"><i class="fa fa-history"></i></li>
									<li title="Report" class="bad-report"><i class="fa fa-flag"></i></li>
									<li title="Stop Post" class="bane"><i class="fa fa-ban"></i></li>
									<li title="Get Post Link" class="get-link"><i class="fa fa-link"></i></li>
									<li title="Copy Embed" class="copy-embd"><i class="fa fa-code"></i></li>
									<li title="Shares" class="share-pst"><i class="fa fa-share-alt"></i><em>125 Shares</em></li>
									<li title="Give Smiles" class="smile-it"><i class="fa fa-smile-o"></i><em>Smile it</em>
										<div class="smiles-bunch">
											<i class="em em---1"></i>
											<i class="em em-smiley"></i>
											<i class="em em-anguished"></i>
								...
								<span class="uploadtime"><i class="fa fa-upload"></i>jan 22, 2020</span>
								<h4>Popstar Never Stop Never Stopping ( 2017 ) Movie.</h4>
							</div>
							<div class="chanel-avatar">
								<figure><a href="channel-detail.html" title=""><img src="images/resources/chanel-avatar.jpg" alt=""></a></figure>
								<div class="channl-author">
									<h5><a href="channel-detail.html" title="">Hobocat Tv</a></h5>
									<span>Member since 2019</span>
									<em>3.2M followers</em>
								</div>
							</div>
							<div class="addnsend">
								<a class="" href="#" title="" data-ripple=""><i class="fa fa-envelope-o"></i> Send Message</a>
								<a class="main-btn" href="#" title="" data-ripple="">Add Friend</a>
							</div>
							<ul class="follow">
								<li><a class="follow-me" href="#" title=""><i class="fa fa-star"></i> Follow Me</a></li>
								<li><a class="contribute" href="#" title=""><i class="fa fa-heart-o"></i> Contribute</a></li>
								<li><span>Following:</span> 320</li>
								<li><span>Followers:</span> 2.5k</li>
							</ul>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="central-meta">
							...
							<div class="related-tube-psts">
								<div class="rlted-video">
									<figure><img src="images/resources/related-tube1.jpg" alt=""></figure>
									<div class="tube-pst-meta">
										<h5><a href="#" title="">Couple dating on the velintine day</a></h5>
										<span>2.2k views</span>
										<div class="user-fig">
											<img src="images/resources/tube-user9.jpg" alt="">
											<a href="#" title="">Alisa</a>
										</div>
									</div>
								</div>
								<div class="rlted-video">
									<figure><img src="images/resources/related-tube2.jpg" alt=""></figure>
									<div class="tube-pst-meta">
										<h5><a href="#" title="">Sea life is good than human life ;)</a></h5>
										<span>3.2M views</span>
										<div class="user-fig">
											<img src="images/resources/tube-user8.jpg" alt="">
											<a href="#" title="">Emily Brwon</a>
										</div>
									</div>
								</div>
								<div class="rlted-video">
									<figure><img src="images/resources/related-tube3.jpg" alt=""></figure>
									<div class="tube-pst-meta">
										<h5><a href="#" title="">Birds always love with poeple but people not</a></h5>
										<span>3.2M views</span>
										<div class="user-fig">
											<img src="images/resources/tube-user7.jpg" alt="">
											<a href="#" title="">Prince Hot</a>
										</div>
									</div>
								</div>
								<div class="rlted-video">
									<figure><img src="images/resources/related-tube4.jpg" alt=""></figure>
									<div class="tube-pst-meta">
										<h5><a href="#" title="">My first journy to Miami beach 2020</a></h5>
										<span>3.2M views</span>
										<div class="user-fig">
											<img src="images/resources/tube-user6.jpg" alt="">
											<a href="#" title="">Sophia</a>
										</div>
									</div>
								</div>
								<div class="rlted-video">
									<figure><img src="images/resources/related-tube5.jpg" alt=""></figure>
									<div class="tube-pst-meta">
										<h5><a href="#" title="">A Complete photoshoot in paris for teens only</a></h5>
										<span>3.2M views</span>
										<div class="user-fig">
											<img src="images/resources/tube-user5.jpg" alt="">
											<a href="#" title="">Kamini Tv</a>
										</div>
									</div>
								</div>
							</div>
							<div class="pit-tags">
								<span>Tags: </span>
								<a title="" href="#">News</a>
								<a title="" href="#">Gaming</a>
								<a title="" href="#">Sports</a>
								<a title="" href="#">Health</a>
								<a title="" href="#">Website</a>
								<a title="" href="#">Love</a>
								<a title="" href="#">Fashion</a>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="central-meta">
							...
							<div class="about-video">
                                ...
                                <div>
                                    ...
                                    <p class="read-more-wrap">This is Hobocat channel, we are working for the dance and sing songs. this video is very awesome for the youngster. please vote this video and like our channel.dance is the great thing for the body and fitness, we aleady have dance team the name of channel is Alps channel..... <span class="read-more-target">Libero fuga facilis vel consectetur quos sapiente deleniti eveniet dolores tempore eos deserunt officia quis ab? Excepturi vero tempore minus beatae voluptatem!</span></p>
					...
					<div class="col-lg-4">
						<div class="central-meta">
							...
							<div class="more-tube-psts">
								<div class="rlted-video">
									<figure><img src="images/resources/related-tube6.jpg" alt=""></figure>
									<div class="tube-pst-meta">
										<h5><a href="#" title="">Boats and ships are looking ambinent in the sea</a></h5>
										<span>3.2M views</span>
										<div class="user-fig">
											<img src="images/resources/tube-user10.jpg" alt="">
											<a href="#" title="">Hobo Tv</a>
										</div>
									</div>
								</div>
								<div class="rlted-video">
									<figure><img src="images/resources/related-tube7.jpg" alt=""></figure>
									<div class="tube-pst-meta">
										<h5><a href="#" title="">My Gf is awating for me alon in the forest.</a></h5>
										<span>3.2M views</span>
										<div class="user-fig">
											<img src="images/resources/tube-user11.jpg" alt="">
											<a href="#" title="">Apna Tv</a>
										</div>
									</div>
								</div>
								<div class="rlted-video">
									<figure><img src="images/resources/related-tube8.jpg" alt=""></figure>
									<div class="tube-pst-meta">
										<h5><a href="#" title="">Joker always pray for us and earn little life.</a></h5>
										<span>3.2M views</span>
										<div class="user-fig">
											<img src="images/resources/tube-user12.jpg" alt="">
											<a href="#" title="">Sara jane</a>
										</div>
									</div>
								</div>
								<div class="rlted-video">
									<figure><img src="images/resources/related-tube9.jpg" alt=""></figure>
									<div class="tube-pst-meta">
										<h5><a href="#" title="">Muslims never leave masjid in his life.</a></h5>
										<span>3.2M views</span>
										<div class="user-fig">
											<img src="images/resources/tube-user13.jpg" alt="">
											<a href="#" title="">Zakar burg</a>
										</div>
									</div>
								</div>
								<div class="rlted-video">
									<figure><img src="images/resources/related-tube10.jpg" alt=""></figure>
									<div class="tube-pst-meta">
										<h5><a href="#" title="">New stunt bike race in paris 2020</a></h5>
										<span>3.2M views</span>
										<div class="user-fig">
											<img src="images/resources/tube-user10.jpg" alt="">
											<a href="#" title="">Hobo Tv</a>
