...
<head>
	...
	<title>ResearchRemix - Dashboard</title>
...
<body>
	...
	<div class="theme-layout">
		...
		<!-- <div class="topbar stick">
			...
			<div class="top-area">
				...
				<ul class="setting-area">
					...
					<li><a href="#" title="Help" data-ripple=""><i class="fa fa-question-circle"></i></a>
						<div class="dropdowns helps">
							...
							<ul class="help-drop">
								...
								<li><a href="privacy.html" title=""><i class="fa fa-pencil-square-o"></i>Terms &
										Policy</a></li>
					...
					<li class="ur-balance">
						<a href="newsfeed.html" title="Your Balance" data-ripple=""><i
								class="fa fa-database"></i></a>$2000
						<div class="dropdowns">
							<span>Account Summary<a href="#" title="">View all</a></span>
							<div class="summary">
								<div class="sumary-head">
									<span>Balance $2000</span>
								</div>
								<ul class="sumary-meta">
									<li>
								...
								<div class="more-activity">
									<a class="active" href="#" title="">Activity</a>
									<a href="#" title="">Statement</a>
		...
		<section>
			<div class="page-header">
				<div class="header-inner">
					<h2>ResearchRemix - Admin Dashboard</h2>
		...
		<section>
			<div class="gap gray-bg" style=" min-height: 70vh;">
				<div class="container">
					<div class="row merged20">
						<div class="col-lg-9">
							<div class="central-meta">
								<h4 class="meta-title"><i class="fa fa-bullhorn"></i> Choose a Goal </h4>
								<div class="row merged20">
									...
									<!-- <div class="col-lg-4 col-md-6">
										<div class="boost-box">
											<a href="#" title="">
												...
												<span>Boost Your Existing Post From Timeline</span>
											</a>
										</div>
									</div> -->
									<!-- <div class="col-lg-4 col-md-6">
										<div class="boost-box">
											<a href="#" title="">
												...
												<span>Promote Your Premium Apps</span>
											</a>
										</div>
									</div> -->
									<div class="col-lg-4 col-md-6">
									...
									<div class="col-lg-4 col-md-6">
										<div class="boost-box">
											<a href="report.php" title="">
												<i class="fa fa-flag-checkered"></i>
												<span>Video Violation Report</span>
											</a>
										</div>
									</div>
									<div class="col-lg-4 col-md-6">
						...
						<div class="col-lg-3">
							<aside class="sidebar static">
								...
								<!-- <div class="widget">
								 ...
								 -->
								<div class="widget">
									<h4 class="widget-title">Recent Reports</h4>
