...
<head>
    ...
    <title>Research Channel - ResearchRemix </title>
...
<body>
    ...
    <div class="theme-layout">
        ...
        <!-- if user channel profile is found -->

        <?php
        //fetch user from db 
        $query = "SELECT * FROM users WHERE oauth_uid='$chnl_id' Or username ='$chnl_id' LIMIT 1;";
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="profile-author">
                                                        <div class="profile-author-thumb">
                                                            <img alt="author" src="<?= $row['picture'] ?>">
                                                            <!-- <div class="edit-dp">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="gen-metabox">
                                                        <span><i class="fa fa-puzzle-piece"></i> About The Profile</span>
                                                        <p>
                                                            <?= $row['bio'] ?>
                                                        </p>
                                                    </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="gen-metabox no-margin">
                                                        ...
                                                        <ul class="sociaz-media">
                                                            ...
                                                            ?>
                                                            <li><a class="facebook" href="<?= $links[0] ?>" title=""><i
                                                                        class="fa fa-facebook"></i></a></li>
                                                            <li><a class="twitter" href="<?= $links[1] ?>" title=""><i
                                                                        class="fa fa-twitter"></i></a></li>
                                                            <li><a class="google" href="<?= $links[2] ?>" title=""><i
                                                                        class="fa fa-linkedin"></i></a></li>

                                                            <li><a class="instagram" href="<?= $links[3] ?>" title=""><i
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active fade show" id="link1">
                                                <div class="row merged20">
                                                    <!-- <div class="col-lg-7">
                                                                                <div class="central-meta">
                                                                                    <div class="create-post">Author Message</div>
                                                                                    <iframe height="330"
                                                                                        src="https://www.youtube.com/embed/X4YsJt4rIOI"
                                                                                        allowfullscreen></iframe>
                                                                                </div>
                                                                            </div> -->
                                                    <!-- <div class="col-lg-5">
                                                                                <div class="central-meta">
                                                                                    <div class="create-post">About Author</div>
                                                                                    <div class="about-chnl">
                                                                                        <ul>
                                                                                            <li><span>Business Name:</span> Yahoo Entertainment</li>
                                                                                            <li><span>Located:</span> Toronto, Canada</li>
                                                                                            <li><span>Member Since:</span> December 22, 2019</li>
                                                                                            <li><span>Videos:</span> 204 Videos Publised</li>
                                                                                            <li><span>Views:</span> 500,230,198</li>
                                                                                            <li><span>Followers:</span> 2109</li>
                                                                                        </ul>
                                                                                        <span>Contribute us to promote our channel for better
                                                                                            performance and you may hire us as freelance</span>
                                                                                        <a href="#" title="" class="main-btn" data-ripple=""><i
                                                                                                class="fa fa-heart"></i> Contribute Us</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div> -->
                                                    <!-- <div class="col-lg-5">
                                                                                        ...
                                                                                        <div class="col-lg-6">
                                                                                            <div class="gen-metabox">
                                                                                                <span><i class="fa fa-puzzle-piece"></i>
                                                                                                    Hobbies</span>
                                                                                                <p>
                                                                                                    I like to ride the bicycle, swimming, and
                                                                                                    working out. I also like reading design
                                                                                                    magazines, and searching on internet, and also
                                                                                                    binge watching a good hollywood Movies while
                                                                                            ...
                                                                                            <div class="gen-metabox">
                                                                                                <span><i class="fa fa-plus"></i> Others
                                                                                                    Interests</span>
                                                                                                <p>
                                                                                                    Swimming, Surfing, Uber Diving, Anime,
                                                                                        ...
                                                                                        <div class="col-lg-6">
                                                                                            <div class="gen-metabox">
                                                                                                <span><i class="fa fa-mortar-board"></i>
                                                                                                    Education</span>
                                                                                                <p>
                                                                                                    Master of computer science, sixteen years degree
                                                                                                    From <a href="#" title="">Oxford Uniersity,
                                                                                                        London</a>
                                                                                                </p>
                                                                                            </div>
                                                                                            <div class="gen-metabox">
                                                                                                <span><i class="fa fa-certificate"></i> Work and
                                                                                                    experience</span>
                                                                                                <p>
                                                                                                    Currently working in the "color hands" web
                                                                                                    development agency from the last 5 five years as
                                                                                                    <a href="#" title="">Senior UI/UX Designer</a>
                                                                                                </p>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-lg-6">
                                                    ...
                                                    <div id="#link2" class="col-lg-12">
                                                        <div class="central-meta">
                                                            <div class="create-post">Chanel's Videos</div>
                                                            <div class="row merged20">
                                                                <?php
                                                                $sql = "SELECT * FROM videos WHERE user_id='$chnl_id' ORDER BY date DESC";
                                                                            ...
                                                                            <div class="tube-post">
                                                                                <figure>
                                                                                    <img src="<?= $row['thumbnail_path'] ?>"
                                                                                        ...
                                                                                        alt="<?= $row['title'] ?>">
                                                                                    <!-- <div class="save-post" title="Watch Later"><i
                                                                                    ...
                                                                                    <div class="more">
                                                                                        <div class="more-post-optns"><i
                                                                                                class="ti-more-alt"></i>
                                                                                            <ul>
                                                                                                <!-- <li class="send-mesg"><i
                                                                                                                                                                        class="fa fa-comment"></i>Send
                                                                                                                                                                    Message</li>
                                                                                                                                                                <li class="bad-report"><i
                                                                                                                                                                        class="fa fa-flag"></i>Report Post
                                                                                                                                                                </li> -->
                                                                                                <li class="share-pst"><i
                    ...
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="robo-image">
                                    <div class="v-center">
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="206.5px"
                                            viewBox="0 0 326.5 592" style="enable-background:new 0 0 326.5 592;"
                                            xml:space="preserve">
                                            <style type="text/css">
                                                .st0 {
                                                    fill: #ab8383;
                                        ...
                                        trSlLW1pS1va0pb2j9T+R4ABAOgiAP26ckJ4AAAAAElFTkSuQmCC" transform="matrix(1 0 0 1 66.2048 489)">
                                            ...
                                            <g id="robot_1_">
                                                ...
                                                <g id="light_1_">
                                                    ...
                                                    <image style="overflow:visible;opacity:0.83;" width="142" height="143"
                                                        xlink:href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAI4AAACPCAYAAAAsoeOtAAAACXBIWXMAAAsSAAALEgHS3X78AAAA
                                        ...
                                        dtttt91222233Xbbbbfddtttt9122+3L2z8CDAAGA9CHeMiJOgAAAABJRU5ErkJggg==" transform="matrix(1 0 0 1 92.2048 0)">
                                                ...
                                                <ellipse id="rightEye_1_" class="st0" cx="215.5" cy="206.9" rx="11.2"
                                                    ry="16" />
                                                <ellipse id="leftEye_1_" class="st0" cx="108.7" cy="206.9" rx="11.2"
                                                    ry="16" />
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-7">
                                <div class="robo-meta">
                                    <div class="v-center">
                                        <h1 style=" color: black;">Oops Error 404</h1>
                                        <span style=" color: black;">The requested URL was not found on the server</span>
                                        <p style=" color: black;">Sorry we can't find the page you're looking for. Please make sure you've entered
                                            the correct address, or return to home.
                                        </p>
                                        <a href="research.php?id=<?=$id ?>" title="" class="main-btn">Back to Home</a>
                                    </div>
                                </div>
                            </div>
                        </div>
